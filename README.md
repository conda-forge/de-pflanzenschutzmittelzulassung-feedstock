About de-pflanzenschutzmittelzulassung-feedstock
================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/de-pflanzenschutzmittelzulassung-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/de-pflanzenschutzmittelzulassung-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add de-pflanzenschutzmittelzulassung
# for installing globally
pixi global install de-pflanzenschutzmittelzulassung
```
...
It is possible to list all of the versions of `de-pflanzenschutzmittelzulassung` available on your platform:
...
```
pixi search de-pflanzenschutzmittelzulassung --channel conda-forge
```
